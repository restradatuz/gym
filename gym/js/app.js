...
Echo.chanel('viajes-channel').listen('NuevoViaje', function (data) {
  console.log(data);
});
...
window.io = socket_io_client__WEBPACK_IMPORTED_MODULE_1___default.a; // window.Pusher = require('pusher-js');

window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__["default"]({
  broadcaster: 'socket.io',
  host: 'http://localhost:6001' // key: process.env.MIX_PUSHER_APP_KEY,
...
__webpack_require__(/*! /Users/saulayala/Proyectos/reisen-webadmin/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/saulayala/Proyectos/reisen-webadmin/resources/sass/app.scss */"./resources/sass/app.scss");
